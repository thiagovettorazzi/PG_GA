...
public:
	...
	// Verificação se o avião bateu na mão
	bool verificaColisaoComAMao(float alturaMao, float comprimentoMao, float posicaoMaoY);

	// Verificação se o avião bateu no final da tela
	bool verificaColisaoComFinalTela();
